...
statics: {
	is_cat: function(animal) {
		return animal.name === "henry";
	}
},
taking: [
	{from: jam.Indexable, these: ["gloo"]}
]
});

var dog = Animal("rover", 4);
var cat = Animal("henry", 9);

function speak(animal) {
	console.log("hellow, my name is " + animal.name + ", and my age is " + animal.age);
}
