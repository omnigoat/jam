...
(function(undefined){
	...
	$.extend(jam.ui.tabs, {
		init: function(elem, options)
		{
			...
			this.tabs_set.add_all(this.$tabs.get());
			...
			.bind("drag", function()
			{
				...
				var $this = $(this),
				    this_index = widget.tabs_set.index_of(this)
				    ;
			...
			.bind("dragstop", function()
			{
				...
				$this.animate({
					left: (widget.tabs_set.index_of(this) - $this.index()) * $(this).outerWidth()
				}, 100);
			});
		...
		_swap_prev_tab: function($current)
		{
			var current = $current.get(0),
			    current_index = this.tabs_set.index_of(current),
