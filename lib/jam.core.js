...
var jam = (function(undefined) {
	...
	jam.extend(jam, {
		prototype: function(definitions)
		{
			...
			jam.each(definitions.accessors, function(accessor, name, accessors) {
			...
			jam.each(definitions.methods, function(method, name, methods) {
			...
			function jam_Object() {
				...
				if ("Proxy" in window && (definitions.dynamic_accessors || definitions.dynamic_methods)) {
					var target = obj;
