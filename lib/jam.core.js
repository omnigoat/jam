...
var jam = (function($, undefined) {
	...
	$.extend(jam, {
		prototype: function(definitions)
		{
			...
			//---------------------------------------------------------------------
			if (definitions.method_missing && "Proxy" in window) {
				...
				jam_Object.prototype = Object.create(supr.prototype, {
				...
				jam_Object.prototype.constructor = jam_Object;
			}
	...
	jam.BaseObject.prototype = {
		constructor: {value: jam.BaseObject},

		_define_members: function(map) {
			jam.each(map, {this_object: this}, function(v, k) {
