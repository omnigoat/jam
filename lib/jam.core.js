...
var jam = (function($, undefined) {
	...
	jam.placeholder = function(i) {
		this.value = i;
	};

	jam.identity = function() {};
	...
	$.extend(jam, {
		prototype: function(definitions)
		{
			function jam_Object() {
				...
				jam_Object.prototype.__init__ && jam_Object.prototype.__init__.apply(self, arguments);
				return self;
			};

			if (definitions.statics) {
				for (var x in definitions.static_members) {
