...
var jam = (function($, undefined) {
	...
	$.extend(jam, {
		prototype: function(definitions)
		{
			...
			//---------------------------------------------------------------------
			if (jam_Object.__def__.method_missing && "Proxy" in window) {
			...
			// accessors
			//---------------------------------------------------------------------
			jam.each(jam_Object.__def__.accessors, function(v, k) {
			...
			// methods
			//---------------------------------------------------------------------
			jam.each(jam_Object.__def__.methods, function(v, k) {
				Object.defineProperty(jam_Object.prototype, k, {
					value: v,
					writable: true,
					enumerable: k.match(/^_/) == null
			...
			// static methods
			//---------------------------------------------------------------------
			jam.each(jam_Object.__def__.statics, function(v, k) {
				jam_Object[k] = v;
			});
			...
			Object.defineProperty(jam_Object.prototype, "_mixin", {
				value: function(mixin) {
					jam.each(mixin, {this_object: this}, function(v, k) {
						Object.defineProperty(this, k, {
							get: v instanceof Function ? v : v.get,
							set: v instanceof Function ? undefined : v.set,
							enumerable: k.match(/^_/) == null
