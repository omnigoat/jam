...
var jam = (function($, undefined) {
		...
		prototype: function(definitions)
		{
			...
			jam_Object.prototype.__jam_init__ = function()
			{
				if (jam_Object.prototype.__supers__) {
					jam.each(jam_Object.prototype.__supers__, {this_object: this}, function(super_init) {
						super_init.call(this);
					});
				}

				jam_Object.prototype.__init__ && jam_Object.prototype.__init__.apply(this, arguments);
			};
	...
	*/
	...
	$.extend(jam, {
		...
		{
			// under certain circumstances, we can simply pass through to the built-in function
			if (options.this_object !== undefined && callbacks.between === undefined && !options.break_required) {
				Array.prototype.forEach.call(range, fn, options.this_object);
				return range;
			}
