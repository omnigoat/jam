...
var jam = (function($, undefined) {
	...
	//=====================================================================
	// Add 'bound_to' to Function's prototype
	//=====================================================================
	if (Function.prototype.bound_to === undefined)
	{
		Function.prototype.bound_to = function(this_object)
		{
			var fn = this;
			return function() {
		...
		console.error("Function.prototype.bound_to is already defined");
	}
